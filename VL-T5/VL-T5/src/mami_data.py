...
dataset_dir = "/opt/datasets/mmf/datasets/mami/defaults"
...
# annotations_fp = "/opt/mshee/hateful-memes-annotation-tool/server/scripts_reevaluation/mami_evaluations/mami_sampled_memes_orig.json"
annotations_fp = "/opt/mshee/hateful-memes-annotation-tool/server/scripts_reevaluation/training/sampled_mami_train_reasonings.json"
...
class FHMTestEvaluator:
    ...
    def evaluate(self, predicts, answers):
        ...
        # compute metrics
        bertscore_results = self.bertscore.compute(predictions=predicts, references=answers, lang="en")
