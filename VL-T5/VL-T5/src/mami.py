...
from mami_data import get_loader
...
class Trainer(TrainerBase):
    ...
    def train(self):
        ...
        for epoch in range(epochs):
            ...
            # Validation
            valid_results = self.evaluate(self.val_loader, validation_strat)
    ...
    def test(self):
        ...
        for name, strat in strategies:
            ...
            candidate_filepath = os.path.join(self.args.output, "%s_mami_warmup_candidates.txt" % name)
