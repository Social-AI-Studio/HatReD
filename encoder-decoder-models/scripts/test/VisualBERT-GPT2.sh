...
python -u main.py \
    ...
    --DEC_MODEL_NAME "gpt2-base" \
    --SAVE_FILEPATH "visualbert-gpt2-base-$seed-$lr-$warmup" \
    --TEST_MODEL_FILEPATH "./fhm/visualbert-gpt2-base-$seed-$lr-$warmup-best-harmonic-mean.pt" \
    --BATCH_SIZE 16 \
    --EPOCHS 30 \
    ...
    --FEATURES_FILEPATH "../datasets/hatred/features/clean/" \
    --TARGET_MODE 'random' \
    --CUDA_DEVICE cuda:0 
